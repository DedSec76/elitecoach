...
export const QuickActionButton = ({handleClick, name_action, name_icon="", bg="success"}) => {
    ...
    return (
        <button onClick={handleClick} className={`w-full flex items-center justify-between p-stack-md bg-white/5 ${background} group transition-all text-left`}>
